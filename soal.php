		...
		if (!empty($img)) { ?>
			<div class="col-12">
				<button type="button" class="btn " data-bs-toggle="modal" data-bs-target="#zoom">
					<img src="images/<?php echo $img ?>" alt="" srcset="" class="media" id="myImgt">
				</button>
			</div>
		<?php } ?>
	</div>
...
<?php if (!empty($des || $kd_des)) { ?>
	...
	<div class="row mx-md-5 mx-auto my-3 fs-5 gap-3">
		...
		<div class="row">
			<div class="col-auto">
				<input type="radio" class="btn-check" name="jwb" id="jwbA" value="A" autocomplete="off" <?php if ($jwbn=="A") {echo "checked";} ?>>
			...
			<?php if (!empty($img_a)) { ?>
				<div class="col-auto">
					<button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#zoom">
						<img src="images/<?php echo $img_a ?>" alt="" srcset="" class="img-thumbnail" style="max-width: 240px;" id="myImgA">
				</div>
			<?php } ?>
		</div>
		<div class="row">
			<div class="col-auto">
				<input type="radio" class="btn-check" name="jwb" id="jwbB" value="B" autocomplete="off" <?php if ($jwbn=="B") {echo "checked";} ?>>
			...
			<?php if (!empty($img_b)) { ?>
				<div class="col-auto">
					<button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#zoom">
						<img src="images/<?php echo $img_b ?>" alt="" srcset="" class="img-thumbnail" style="max-width: 240px;" id="myImgB">
				</div>
			<?php } ?>
		</div>
		<div class="row">
			<div class="col-auto">
				<input type="radio" class="btn-check" name="jwb" id="jwbC" value="C" autocomplete="off" <?php if ($jwbn=="C") {echo "checked";} ?>>
			...
			<?php if (!empty($img_c)) { ?>
				<div class="col-auto">
					<button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#zoom">
						<img src="images/<?php echo $img_c ?>" alt="" srcset="" class="img-thumbnail" style="max-width: 240px;" id="myImgC">
				</div>
			<?php } ?>
		</div>
		<div class="row">
			<div class="col-auto">
				<input type="radio" class="btn-check" name="jwb" id="jwbD" value="D" autocomplete="off" <?php if ($jwbn=="D") {echo "checked";} ?>>
			...
			<?php if (!empty($img_d)) { ?>
				<div class="col-auto">
					<button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#zoom">
						<img src="images/<?php echo $img_d ?>" alt="" srcset="" class="img-thumbnail" style="max-width: 240px;" id="myImgD">
				</div>
			<?php } ?>
		</div>
		<div class="row">
			<div class="col-auto">
				<input type="radio" class="btn-check" name="jwb" id="jwbE" value="E" autocomplete="off" <?php if ($jwbn=="E") {echo "checked";} ?>>
			...
			<?php if (!empty($img_e)) { ?>
				<div class="col-auto">
					<button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#zoom">
						<img src="images/<?php echo $img_e ?>" alt="" srcset="" class="img-thumbnail" style="max-width: 240px;" id="myImgE">
				</div>
			<?php } ?>
		</div>
	</div>
	...
	<!-- === Akhir Jawabn Esai === -->
	<!-- === Akhir Soal Esai === -->
<?php }}else{echo "<div class='col text-center p-3 fs-4'>Soal Tidak di Temukan</div>";} ?>
...
<script>
	...
	$(document).ready(function() {
		$('input[type="radio"]').click(function() {
			// var jwb = document.getElementsByName("nos").innerHTML;
			var jwb = $(this).val();
			console.log(jwb);
			$.ajax({
				url: "soal_jwb.php",
