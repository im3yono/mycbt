		...
		<table class="table table-bordered border-dark text-center">
			<thead>
				<tr>
					...
					<th rowspan="2" valign="middle" class="text-center">No. Peserta</th>
					<th rowspan="2" valign="middle" class="text-center">Nama</th>
					<?php
					// $qr_no = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM cbt_pktsoal WHERE kd_soal ='$kds'"));
					...
					<?php if (!empty($qr_no['esai'])) {
						echo '<th rowspan="2" valign="middle" class="text-center">Esai<br>(' . $qr_no['esai'] . ')</th>';
					} ?>
					<th rowspan="2" valign="middle" class="text-center">Nilai</th>
					<th rowspan="2" valign="middle" class="text-center">Keterangan</th>
				</tr>
				<tr>
					<?php
					...
					?>
					<th valign="middle" class="text-center">Benar</th>
					<th valign="middle" class="text-center">Salah</th>
				</tr>
			</thead>
			<tbody>
				<?php
				...
				?>
					<tr>
						...
						for ($i = 1; $i <= $qr_jmlno; $i++) {
							...
							echo '<td class="text-center" style="width: 10mm;">';
							if (!empty($b[$i - 1])) {
								echo $b[$i - 1];
							}
							echo ' </td>';
