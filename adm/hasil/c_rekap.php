...
?>
	...
	<body>
		<div class="row justify-content-center m-0">
			<div class="col-12 p-3" style="border-radius: 7px; margin-top: 30px;">
				<table class="table table-borderless">
					<tr>
						<td style="width: auto;">Nama Mapel</td>
						<td>: </td><td class="fw-bold"><?php echo $qr_mpel['nm_mpel'] ?></td>
					...
					<tr>
						...
						<td>: </td><td> <?php echo $qr_no['author'] ?></td>
					</tr>
					<tr>
						<td>Kelas</td>
						<td>: </td><td><?php echo $kls ?></td>
					</tr>
				</table>
				<!-- <div class="row"></div> -->
					...
					<tbody class="text-center">
						...
						?>
							<tr>
								...
								<td class="text-start"><?php echo "Kelas | Jurusan" ?></td>
								<!-- <td><?php echo $data['nil_pg'] ?></td>
								<td><?php echo $data['nil_es'] ?></td> -->
								<td class="fw-bold <?php echo $tex.'">'. $data['nilai'] ?></td>
								<td><a href="#" class="btn btn-outline-primary"><i class="bi bi-eye"> Lihat</i></a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
