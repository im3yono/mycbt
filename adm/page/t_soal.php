				...
				<div class="border border-info-subtle" style="border-radius: 5px;">
					<div class="row m-0 bg-info-subtle p-2 justify-content-center justify-content-md-start">
						...
						<div class="col-auto form-check form-switch">
							<input type="radio" class="form-check-input" role="switch" name="keyopsi" id="keyopsi" required	 value="1">
						</div>
					</div>
			...
			<div class="col-12 p-2" style="border-radius: 3px;">
				<div class="border border-info-subtle" style="border-radius: 5px;">
					<div class="row m-0 bg-info-subtle p-2 justify-content-center justify-content-md-start">
						...
						<div class="col-auto form-check form-switch">
							<input type="radio" class="form-check-input" role="switch" name="keyopsi" id="keyopsi" value="2">
						</div>
					</div>
					<div class="row gap-3 p-3 justify-content-center">
						<div class="col-md-2 col-6">
							<div class="text-center col">
								...
								<label for="imgjw2" style="cursor: pointer;"><img src="../img/img.png" id="img2" class="card-img-top img-fluid" alt="..." style="height: 7rem;"></label>
								<input type="text" class="form-control form-control-sm text-center m-1" name="img2jw" id="img2jw" value="" readonly>
							</div>
						</div>
						<div class="col-md col-auto">
							<textarea name="opsi2" id="opsi2"></textarea>
						</div>
					</div>
				</div>
			</div>
			<div class="col-12 p-2" style="border-radius: 3px;">
				<div class="border border-info-subtle" style="border-radius: 5px;">
					<div class="row m-0 bg-info-subtle p-2 justify-content-center justify-content-md-start">
						...
						<div class="col-auto form-check form-switch">
							<input type="radio" class="form-check-input" role="switch" name="keyopsi" id="keyopsi"  value="3">
						</div>
					</div>
					<div class="row gap-3 p-3 justify-content-center">
						<div class="col-md-2 col-6">
							<div class="text-center col">
								...
								<label for="imgjw3" style="cursor: pointer;"><img src="../img/img.png" id="img3" class="card-img-top img-fluid" alt="..." style="height: 7rem;"></label>
								<input type="text" class="form-control form-control-sm text-center m-1" name="img3jw" id="img3jw" value="" readonly>
							</div>
						</div>
						<div class="col-md col-auto">
							<textarea name="opsi3" id="opsi3"></textarea>
						</div>
					</div>
				</div>
			</div>
			<div class="col-12 p-2" style="border-radius: 3px;">
				<div class="border border-info-subtle" style="border-radius: 5px;">
					<div class="row m-0 bg-info-subtle p-2 justify-content-center justify-content-md-start">
						...
						<div class="col-auto form-check form-switch">
							<input type="radio" class="form-check-input" role="switch" name="keyopsi" id="keyopsi"  value="4">
						</div>
					</div>
					<div class="row gap-3 p-3 justify-content-center">
						<div class="col-md-2 col-6">
							<div class="text-center col">
								...
								<label for="imgjw4" style="cursor: pointer;"><img src="../img/img.png" id="img4" class="card-img-top img-fluid" alt="..." style="height: 7rem;"></label>
								<input type="text" class="form-control form-control-sm text-center m-1" name="img4jw" id="img4jw" value="" readonly>
							</div>
						</div>
						<div class="col-md col-auto">
							<textarea name="opsi4" id="opsi4"></textarea>
						</div>
					</div>
				</div>
			</div>
			<div class="col-12 p-2" style="border-radius: 3px;">
				<div class="border border-info-subtle" style="border-radius: 5px;">
					<div class="row m-0 bg-info-subtle p-2 justify-content-center justify-content-md-start">
						...
						<div class="col-auto form-check form-switch">
							<input type="radio" class="form-check-input" role="switch" name="keyopsi" id="keyopsi"  value="5">
						</div>
					</div>
					<div class="row gap-3 p-3 justify-content-center">
						<div class="col-md-2 col-6">
							<div class="text-center col">
								...
								<label for="imgjw5" style="cursor: pointer;"><img src="../img/img.png" id="img5" class="card-img-top img-fluid" alt="..." style="height: 7rem;"></label>
								<input type="text" class="form-control form-control-sm text-center m-1" name="img5jw" id="img5jw" value="" readonly>
							</div>
						</div>
						<div class="col-md col-auto">
							<textarea name="opsi5" id="opsi5"></textarea>
						</div>
					</div>
				</div>
			</div>
