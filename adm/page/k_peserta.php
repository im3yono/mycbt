...
<div class="container-fluid mb-0 p-0">
	<div class="row p-2 border-bottom fs-3 mb-4 shadow-sm ">Kartu Peserta</div>
	<form action="print/c_kps.php" method="post" id="form" target="prt">
...
<div class="row">
	<iframe src="print/c_kps.php" name="prt" id="prt" style="display: yes; width: 100%;height: 73vh;"></iframe>
	<!-- <div id="tampil"></div> -->
</div>
</div>