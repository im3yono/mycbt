...
<div class="container-fluid mb-5 p-0">
	...
	<div class="row">
		<div class="col-lg-6 col-12 p-2 border">
			<iframe src="hasil/c_rekap.php" name="prt" id="prt" style=" width: 100%;height: 73vh; border-radius: 5px;" class="col-lg-6 col-12 p-2 border shadow"></iframe></div>
		<div class="col p-2 border">
		<div class="row mx-1 p-2 border border shadow" style="border-radius: 5px;">mmmmm</div>
		</div>
	</div>
</div>
