...
// echo $telat2;
	$inqr	= "INSERT INTO jdwl (id_ujian, kd_ujian, smt, kls, kd_kls, jur, nm_kls, kd_mpel, kd_soal, jm_login, tgl_uji, jm_uji, bts_login, lm_uji, token, author, thn_ajr, user, sesi, sts, sts_token, sts_nilai) VALUES (NULL, 'UH', '1', '$kls', '$kkls', '$jur', '', '$mpel', '$kds', '', '$tgl', '$jm_awal', '$telat2', '$durasi', '$token', '', '2022/2023', '', '$sesi', 'Y', '$ttoken', '$nilai');";
	$upqr	= "UPDATE jdwl SET kls = '$kls', kd_kls = '$kkls', jur = '$jur', nm_kls = '', kd_mpel = '$mpel', jm_login = '', tgl_uji = '$tgl', jm_uji = '$jm_awal', bts_login = '$telat2', lm_uji = '$durasi', token = '$token', author = '', thn_ajr = '2022/2022', sesi = '$sesi', sts = 'Y', sts_token = '$ttoken', sts_nilai = '$nilai' WHERE jdwl.kd_soal = '$kds';";
	$cek	= "SELECT * FROM jdwl WHERE kd_soal ='$kds' AND sts='Y'";
